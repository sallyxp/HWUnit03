...
function generateNewPassword() {
  ...
  var allowed = {};
  if (upper) password += rando(allowed.uppers = "QWERTYUIOPASDFGHJKLZXCVBNM");
  if (lower) password += rando(allowed.lowers = "qwertyuiopasdfghjklzxcvbnm");
  if (numbers) password += rando(allowed.numbers = "1234567890");
  if (special) password += rando(allowed.symbols = "!@#$%^&*(){}[]=<>/,.");
...
//The intention was to substiute the array 'AllChars' generated by my code in place of the randosequence.

for (var i = passwordLength; i < length; i++) password += rando(rando(allowed).value);
